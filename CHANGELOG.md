...
* `git push` the changes from semantic release ([bd60a1d](https://github.com/hhankj2u/StreamMaster/commit/bd60a1df6b902f94b3c1448cff2b0a8a18f2dbfe))
* `main` and `latest` as tracking tags ([55597b6](https://github.com/hhankj2u/StreamMaster/commit/55597b61ca6a3f851863dad7fc73b829b5d034cd))
* `SMButton` was using the wrong class hook ([bfea17b](https://github.com/hhankj2u/StreamMaster/commit/bfea17b89114670106751bd539f8e4d8df0b7a1d))
* Add and use `cp-cli` for cross platform copy ([06d7ec9](https://github.com/hhankj2u/StreamMaster/commit/06d7ec9e76eacafd9e21cfe6516d0196d49c6000))
* Add and use `IsNew` ([b26feb5](https://github.com/hhankj2u/StreamMaster/commit/b26feb53ffcca09420091a0e0aa8af8b018c6569))
* Add API error handler ([8dc8bcd](https://github.com/hhankj2u/StreamMaster/commit/8dc8bcd2c71c1bbd4b3f96c9f611040257c6ada0))
* Add critical operation checks and early exits ([e4e6ba5](https://github.com/hhankj2u/StreamMaster/commit/e4e6ba58f0dbc460aff6f58025d721bc119d375e))
* Add nullglob for safer array handling ([bd218c9](https://github.com/hhankj2u/StreamMaster/commit/bd218c937deab9cdad76b3a0607f4c203c1a8c7b))
* Add Response Compression ([698da5d](https://github.com/hhankj2u/StreamMaster/commit/698da5d5fc696a98a1d3594942eaf9a1d06bbaaf))
* Add retry policy and fail if unable to switch channel ([8ae5c55](https://github.com/hhankj2u/StreamMaster/commit/8ae5c554effe8dfde7857f7ed73e3cc625bed415))
* Add trap for temp script cleanup ([6c7327b](https://github.com/hhankj2u/StreamMaster/commit/6c7327bd4e26e1b87adab8f59a8152878780639d))
* added clear button back to drop down box, only show if selecting multiple options is available ([033d54b](https://github.com/hhankj2u/StreamMaster/commit/033d54bbe6973771de989e53bf4d26296242f972))
* added clear button back to drop down box, only show if selecting multiple options is available ([37c648b](https://github.com/hhankj2u/StreamMaster/commit/37c648bc079372918b578b0a798599f038fe59aa))
* Added loggsettings to backups ([5453521](https://github.com/hhankj2u/StreamMaster/commit/5453521163fdf4e76b8413dfafbcfc42f8a457e0))
* added missing tooltip to dropdown filter button ([91f0ebb](https://github.com/hhankj2u/StreamMaster/commit/91f0ebbe927f0004401b10530cd91f56cabfc11b))
* Added STRM Support to SGs ([674cc78](https://github.com/hhankj2u/StreamMaster/commit/674cc788c9dc88c020bf755014410ae04313a8e4))
* Adjusted regex pattern to capture optional build/revision number ([3b6a1f1](https://github.com/hhankj2u/StreamMaster/commit/3b6a1f13aa4d87660f26baebbf8d5b3b5a8608ca))
* Adjustment to command profiles and groups ([5e8828a](https://github.com/hhankj2u/StreamMaster/commit/5e8828ac70290b307f75cd009f70de0f5a8d3fd1))
* Adjustment to Enum alignment ([0cfbf1f](https://github.com/hhankj2u/StreamMaster/commit/0cfbf1fc24a319792835ff9d207aef1b4f56c107))
* Alignment of remove dmethod in test controller ([1b60971](https://github.com/hhankj2u/StreamMaster/commit/1b609715bf4beb5ab2463771f64c83a366295fba))
* allow UIDs >= 10 ([40dee89](https://github.com/hhankj2u/StreamMaster/commit/40dee89c24040844fce42abbb7925fea3c3a1bf7))
* Attempt to conditionally apply migration ([8c8a8ff](https://github.com/hhankj2u/StreamMaster/commit/8c8a8ff6a4348a849933e848555a7c0eba3d334c))
* Avoid multiple `didIDMigration` inserts ([7b24a02](https://github.com/hhankj2u/StreamMaster/commit/7b24a0245cf0e7efeb90065c3d636f2cbad23ed0))
* backup and restores ([9683749](https://github.com/hhankj2u/StreamMaster/commit/9683749ea923f8ccae84c583e5b04db085c19d29))
* Bug: Schedules Direct EPG data download triggers a failure in SM [#278](https://github.com/hhankj2u/StreamMaster/issues/278) ([ce0811e](https://github.com/hhankj2u/StreamMaster/commit/ce0811e62c44838c764d27851dd228e632cade03))
* bump ([e05b8ec](https://github.com/hhankj2u/StreamMaster/commit/e05b8ecec509c26282f2ec57de18a4aee9efc8cf))
* cache cleanup ([a556f67](https://github.com/hhankj2u/StreamMaster/commit/a556f67ec756d464748453e584f4544bd42e749a))
* Cache EPG logos ([0b31fc9](https://github.com/hhankj2u/StreamMaster/commit/0b31fc961c5868f1bc145089b4d198fd4daa322c))
* Change ID to always ([dc56aa9](https://github.com/hhankj2u/StreamMaster/commit/dc56aa931268001051960dc45f90d6b22a6b4610))
* changed `user-select: none` to `cursor: pointer` to still alow the user to select the text if needed, whilst better indicating selecting an option ([7143a30](https://github.com/hhankj2u/StreamMaster/commit/7143a30c3a27d100937919222b18244881dd2dfc))
* channel handling ([d55d584](https://github.com/hhankj2u/StreamMaster/commit/d55d584fc4ff1a4d0367b8fd2355c1bcb1996ce0))
* client registration dupe ([9195fcb](https://github.com/hhankj2u/StreamMaster/commit/9195fcb1be96174ea86d0e92908a428557caa768))
* convert to pipes ([48b7983](https://github.com/hhankj2u/StreamMaster/commit/48b79838b7bec81c232ebb58916d99a6226f35f7))
* Correct base URL to download images ([b8cb3f0](https://github.com/hhankj2u/StreamMaster/commit/b8cb3f093c547aca429cf64782597f3c3aca8e23))
* correct ignore paths for `/src` ([563d805](https://github.com/hhankj2u/StreamMaster/commit/563d80562c891c1fe2ec0f91605489a82d797ef9))
* Correct link to Docker Hub ([63cf991](https://github.com/hhankj2u/StreamMaster/commit/63cf991fc6d3fe2507401e48dc6d53730737eda5))
* Correct to new `js` path ([5d27e8b](https://github.com/hhankj2u/StreamMaster/commit/5d27e8b706d10ded1534fe2a80db008d63deb96d))
* Correctly handle different logo routes ([40a9c06](https://github.com/hhankj2u/StreamMaster/commit/40a9c066c3391808ac45cd61d5d4a290d835ad20))
* Custom logo selection ([a32defb](https://github.com/hhankj2u/StreamMaster/commit/a32defb645fbf7545f4488bfd3a99be715943f7c))
* custom logos ([2cb5aab](https://github.com/hhankj2u/StreamMaster/commit/2cb5aab4b9cab76849775c78d91a65e035522741))
* Custom playlist scan update channels and logos ([5407116](https://github.com/hhankj2u/StreamMaster/commit/540711600610029ce7d313f542fb73bca15247c4))
* DB initialization ([6bf4659](https://github.com/hhankj2u/StreamMaster/commit/6bf46594856521e55532e8dca7e4bcf8ccdf01d9))
* db migrations ([6952660](https://github.com/hhankj2u/StreamMaster/commit/6952660075168ba3c28d3b166a44e2ea40cbb550))
* Do not ignore Application/Logs ([8f07375](https://github.com/hhankj2u/StreamMaster/commit/8f073751c8ee71304b38b09eab547796119ed07a))
* Documentation moved src destination ([3586466](https://github.com/hhankj2u/StreamMaster/commit/35864661dc40aca4b5c386ee9fe35dc4955e61e7))
* Don't `break` out of the EPG iteration ([539ba01](https://github.com/hhankj2u/StreamMaster/commit/539ba0100efbe550bbed0d7921ab7b650bfe0532))
* Don't ignore `Logs` folder ([2feff80](https://github.com/hhankj2u/StreamMaster/commit/2feff804e2cd059338cb5c7d71e0dfaa9c3063a2))
* Don't launch browser each time ([6705df4](https://github.com/hhankj2u/StreamMaster/commit/6705df4e719e8f611470541380c05b3b48f31f82))
* Don't remove new migrations ([ccd6f90](https://github.com/hhankj2u/StreamMaster/commit/ccd6f905122a5bd4fda5293878b9212135eaeedd))
* dropdown box not showing options to pick ([2a3e4c2](https://github.com/hhankj2u/StreamMaster/commit/2a3e4c2d12eccf697555552d307770ef927f36da))
* Dropdown text alignment ([7486efa](https://github.com/hhankj2u/StreamMaster/commit/7486efa12af8546564616f3e51f68e194b1a510e))
* DTD processing ([643b704](https://github.com/hhankj2u/StreamMaster/commit/643b704c812d66b780c10c10f94740554bc286c6))
* dupe channels ([b42c19f](https://github.com/hhankj2u/StreamMaster/commit/b42c19fcb17d5e0e483a2afa6cfcd3e160d1aec4))
* Eho failures to chmod ([1ca591d](https://github.com/hhankj2u/StreamMaster/commit/1ca591d5691b51b912c157dbb7d71ac1cc31b380))
* Ensure that multiselect value is `''` if null ([0307ec2](https://github.com/hhankj2u/StreamMaster/commit/0307ec29cbbc271fdda72e6305660f4d9ea1d3fb))
* Ensure to re-process `latest` if digest diffs ([c75b69f](https://github.com/hhankj2u/StreamMaster/commit/c75b69fab90f9f155c8e38ea2d2281b9a4fba3bd))
* Ensure to release lock in `final` ([6a76d65](https://github.com/hhankj2u/StreamMaster/commit/6a76d65cc006278d6503d7ced7e34a5897d79044))
* env.sh default_dbpassword ([afcb7ea](https://github.com/hhankj2u/StreamMaster/commit/afcb7eaf132d5811d696d7d5a074bf6e0231ed76))
* env.sh file ([887dd75](https://github.com/hhankj2u/StreamMaster/commit/887dd75c708ebbbd3d1f61bf31ca5d4672f20455))
* epg ([d303367](https://github.com/hhankj2u/StreamMaster/commit/d303367cc598575753bafb9cd794eee4149022f7))
* epg date parser ([16b5be6](https://github.com/hhankj2u/StreamMaster/commit/16b5be6f7c207ff48890212d7069cf9a0b51397e))
* epg number/color on create ([4e71fd7](https://github.com/hhankj2u/StreamMaster/commit/4e71fd7a2c3e4144c30471a04b6b64d38fa40277))
* EPG Programme output ([a5fa82f](https://github.com/hhankj2u/StreamMaster/commit/a5fa82f07ca69e9c61322d7f5b7824523ae5229d))
* epg reader ([5de30d6](https://github.com/hhankj2u/StreamMaster/commit/5de30d6f0ee367fb8958b55521a8807805c7d5f7))
* epg/m3u file system last write ([d5d2ee7](https://github.com/hhankj2u/StreamMaster/commit/d5d2ee78ffb2707c33880470a09ff9f65b32893d))
* EPG/M3U refresh/proc ([aabc523](https://github.com/hhankj2u/StreamMaster/commit/aabc523592e677dc00b02c4e5f15f32566148431))
* epg/m3u/hdhr fixes ([b718050](https://github.com/hhankj2u/StreamMaster/commit/b7180500c4082f7a79c61b370f00de8c82ea031d))
* Expose `SeriesPosterArt` setting ([a3314f7](https://github.com/hhankj2u/StreamMaster/commit/a3314f71f7761691cfd7614b0e0a49c3f4c8b24f))
* Extend button name ([5c9f524](https://github.com/hhankj2u/StreamMaster/commit/5c9f5247e8886cbf72f4167f2c49e5201a15e8de))
* Fallback to EPG logos if channel misses one ([8c4d748](https://github.com/hhankj2u/StreamMaster/commit/8c4d7486145bd702de36720bbeaba41932c74ef0))
* FFMPEG on ARM64 ([4c8d9f5](https://github.com/hhankj2u/StreamMaster/commit/4c8d9f58d94582792ae466041e4c852fd58494f2))
* FILE logic ([584bd3d](https://github.com/hhankj2u/StreamMaster/commit/584bd3d5c8bfa43442f246b5f38460d329eb3278))
* File refresh dupe ([7d5ea4c](https://github.com/hhankj2u/StreamMaster/commit/7d5ea4cd5ce2861b84dbee6ec29d1380a31c985b))
* Filter away potential undefined stations ([a58f8d7](https://github.com/hhankj2u/StreamMaster/commit/a58f8d705c11264fcfdf17eaece99c0bb905780d))
* Fix DtdProcessing in FileUtil.cs ([737d448](https://github.com/hhankj2u/StreamMaster/commit/737d448a0dda4aef989c878f6948cff6e2cf099f))
* Fix FileUtil.GetFileDataStream to return a ([7eace41](https://github.com/hhankj2u/StreamMaster/commit/7eace4175c3d3104ebf6e2819fd5d9c19b81ec78))
* Fix for `AutoSetEPGs` use of `IAsyncEnumerable` ([028f96e](https://github.com/hhankj2u/StreamMaster/commit/028f96ef6ce95c6edd9c2312d50f852af73d53fe))
* Further SD alignment ([eaa5930](https://github.com/hhankj2u/StreamMaster/commit/eaa59307d36ca07d6762a7cdb460460363f41374))
* Handle automatic build on merge inputs ([2bf1cc7](https://github.com/hhankj2u/StreamMaster/commit/2bf1cc7d021a63dbcb89c30f94c7a60421e44c08))
* Handle case where PUID/PGID is `0` ([b759b3a](https://github.com/hhankj2u/StreamMaster/commit/b759b3a692226bcc396c06b5c75ed2ee22a78165))
* Handle failure to creat config.json ([753523f](https://github.com/hhankj2u/StreamMaster/commit/753523f1756bad062bc11ed01e5964762012a5a7))
* Icon selector ([aee88ca](https://github.com/hhankj2u/StreamMaster/commit/aee88ca71ce7694f7cd58a013ac929a2b7f42906))
* image download service cpu usage ([5521e6c](https://github.com/hhankj2u/StreamMaster/commit/5521e6c79bc6e705052eaa5b9da198445b228776))
* image handling ram usage ([a0fb988](https://github.com/hhankj2u/StreamMaster/commit/a0fb9882b5fb90ba9f3524d917a63a7aeb803f82))
* Improve directory rename safety with atomic operation ([8e37e4b](https://github.com/hhankj2u/StreamMaster/commit/8e37e4b50d0e16d8b47bf53fa63251d7fbaec4ee))
* Improve video playback ([34c96cc](https://github.com/hhankj2u/StreamMaster/commit/34c96cc4bdb098dbe6cd11c017d4dceb08296826))
* Include all SQL scripts when building ([44f17dc](https://github.com/hhankj2u/StreamMaster/commit/44f17dc159a823e6791ccba2eb8777538801f116))
* Initial ([#212](https://github.com/hhankj2u/StreamMaster/issues/212)) ([6bcc3a0](https://github.com/hhankj2u/StreamMaster/commit/6bcc3a07ce6d500e4ac154ecf9bba56fd3ac08f9))
* Introduce new project for running migrations ([37c970d](https://github.com/hhankj2u/StreamMaster/commit/37c970d6293feda76a61cbb6e124123e250d6ec6))
* large m3us ([83a23b2](https://github.com/hhankj2u/StreamMaster/commit/83a23b221f39667a15f2683a53fe743b39a9d2e5))
* logos ([45ba41f](https://github.com/hhankj2u/StreamMaster/commit/45ba41f776eb8e896b7afa4144aba9d04b62f647))
* logos list ([44c5ddd](https://github.com/hhankj2u/StreamMaster/commit/44c5ddda20d49d9fd664647d4eaacac052563e3e))
* m3u import speedup ([1db3aa1](https://github.com/hhankj2u/StreamMaster/commit/1db3aa1f856f83e1664d5c2a460fa0a8e1783768))
* M3U Needs update logging ([580d278](https://github.com/hhankj2u/StreamMaster/commit/580d278fe142f4b57f87673742e4ce11b5dc127d))
* M3U Refresh from UI ([7cd0f54](https://github.com/hhankj2u/StreamMaster/commit/7cd0f54abb62f6539106ce44eca6ae4df606db1b))
* M3U Sync ([3219966](https://github.com/hhankj2u/StreamMaster/commit/3219966877fc0eef11bb9b78658d6837c591a03f))
* Make use of `IHttpClientFactory` to get clients ([a7ca54a](https://github.com/hhankj2u/StreamMaster/commit/a7ca54a0685c374ea96a7f98b6f333e2371e957c))
* migrate to net 9 ([ceb6dbf](https://github.com/hhankj2u/StreamMaster/commit/ceb6dbf0aeb8203968374abf605c37aebac48c83))
* Modify icons and text ([e58b645](https://github.com/hhankj2u/StreamMaster/commit/e58b6454ad16a4217dd5f683367b0cf5a492c629))
* Modifying default profiles ([b96e000](https://github.com/hhankj2u/StreamMaster/commit/b96e000f5ad1368551bb35a4af8ccfaf4da9aa2c))
* more metrics ([bf35f98](https://github.com/hhankj2u/StreamMaster/commit/bf35f98ce92e2636cff119c4a95d1533aaba49e9))
* moved backup dir ([a583171](https://github.com/hhankj2u/StreamMaster/commit/a583171c2ee954022c81ff69d9d64592d40d6fb5))
* No release script to single commit and tag ([c037aeb](https://github.com/hhankj2u/StreamMaster/commit/c037aeb43dca55dc888df7ebdfcfbb42f5144ca9))
* Only deploy docs if something in docs changed ([c2866c3](https://github.com/hhankj2u/StreamMaster/commit/c2866c3a03cada03c063233fc8d5d9e57e7ed3c9))
* Persist rank to CurrentRank ([74818c8](https://github.com/hhankj2u/StreamMaster/commit/74818c863edd968ed3e2b03dd688c47f0b50e88e))
* port settings ([d0fa1f4](https://github.com/hhankj2u/StreamMaster/commit/d0fa1f46446ed3a964d638852f80d3c3bab03709))
* prefer explicit channel CommandProfile over M3U8 override ([#1](https://github.com/hhankj2u/StreamMaster/issues/1)) ([b04e3ab](https://github.com/hhankj2u/StreamMaster/commit/b04e3abaf997af810b0299721c0129c9b31101ae))
* Produce git commit and tag on same commit ([e375d2e](https://github.com/hhankj2u/StreamMaster/commit/e375d2eac4aef67d798cb5f1e698ffae7bacdf50))
* Pull full history ([55650ab](https://github.com/hhankj2u/StreamMaster/commit/55650ab00ffb05c75757a67ef08a6d08d54eb7c6))
* Push multi platform at once ([01b7fa2](https://github.com/hhankj2u/StreamMaster/commit/01b7fa2fb862b20ad324f9ac2b6b45fc79dded3b))
* Release tags ([95b7bf8](https://github.com/hhankj2u/StreamMaster/commit/95b7bf83a3b220b339178e4cfbb10992526995ce))
* Remove `--silent` output ([21dbdb7](https://github.com/hhankj2u/StreamMaster/commit/21dbdb759d2b462195fe03b0b8c47adf154ba8f2))
* Remove debug log message ([4435801](https://github.com/hhankj2u/StreamMaster/commit/443580116bf6ca5c209d77491a4ce33c1e1597a4))
* Remove from hook dependency ([84d9be3](https://github.com/hhankj2u/StreamMaster/commit/84d9be34380f7be7b803124c6b9f8b6db35b766f))
* Remove handling of non-existing migration IDs ([4b3398e](https://github.com/hhankj2u/StreamMaster/commit/4b3398e76e6dd3b342131ee4791b19203e023966))
* Run after main workflow name ([d3d8d8e](https://github.com/hhankj2u/StreamMaster/commit/d3d8d8ee2511d4666b1cb9e857249280f656827b))
* SD API response handling ([11c7fe4](https://github.com/hhankj2u/StreamMaster/commit/11c7fe43ba5fc84ef04bdd54c81787cf5d6f38dc))
* SD download limit, 429/5002/5003 ([c06adc7](https://github.com/hhankj2u/StreamMaster/commit/c06adc7ad4e288b8f9a77376455e8c0b81a4c6fb))
* sd stuff ([ab8655e](https://github.com/hhankj2u/StreamMaster/commit/ab8655e332d238b05a3652b0fbb81d862ffdf347))
* sd work ([d4cf0d9](https://github.com/hhankj2u/StreamMaster/commit/d4cf0d9b6da0f067303a2cd82c1b5a083a294b3c))
* Shellcheck related suggestions and fixes ([15a9af0](https://github.com/hhankj2u/StreamMaster/commit/15a9af0d074470cb4f7126831ec71189349a234d))
* Should attempt redirect first ([ae7925b](https://github.com/hhankj2u/StreamMaster/commit/ae7925b6f0d6fdb2b805f6bddf1073f2ecfa4cbb))
* some cleanup ([2c759db](https://github.com/hhankj2u/StreamMaster/commit/2c759db855c9ef00d51e775f5702a4ff2940a8f2))
* Source env things first ([0b46c58](https://github.com/hhankj2u/StreamMaster/commit/0b46c58ae607227620847ce08f7fa8c8e1207a68))
* startup ([2659421](https://github.com/hhankj2u/StreamMaster/commit/26594218b4e34a168d8de60176796d7823a4c9b1))
* streams ([a852070](https://github.com/hhankj2u/StreamMaster/commit/a8520704b64739bcf42e86dc117945a65ebfdf0f))
* support SMFS ([b32aa8e](https://github.com/hhankj2u/StreamMaster/commit/b32aa8e2a43ec04804d5848895c57c9f8f63cabf))
* Trap postgres in case of failure ([2313119](https://github.com/hhankj2u/StreamMaster/commit/2313119ec48f4a29481b7f44d903ddd995b741e0))
* UI build ([34b60cc](https://github.com/hhankj2u/StreamMaster/commit/34b60cc1c0f951f76fa2de6dbf951b38112fb2e1))
* Update cache provider to use sessionStorage ([bf366c0](https://github.com/hhankj2u/StreamMaster/commit/bf366c066d6b2c29200b6896a7fbc45fdb9c8fde))
* Update Dockerfile and entrypoint.sh ([80270b6](https://github.com/hhankj2u/StreamMaster/commit/80270b6a420c3a0142eb6e72874bce3ba787419f))
* update release config ([8935637](https://github.com/hhankj2u/StreamMaster/commit/8935637ffabb5ca599fea3c06f2a23ae9b65c7e7))
* Use `localhost` not `127.0.0.1` ([066d37d](https://github.com/hhankj2u/StreamMaster/commit/066d37d7ff88f26f3f60509e51838ae7c0229405))
* Use `Release` version ([2fe37db](https://github.com/hhankj2u/StreamMaster/commit/2fe37db654f3c724922fef18a16221b9eb658520))
* Use `token` to re-fetch same `github.ref` ([28799d6](https://github.com/hhankj2u/StreamMaster/commit/28799d69514a9a554d47f157a4bb48c76f956429))
* Use PAT for access to `main` ([a30188a](https://github.com/hhankj2u/StreamMaster/commit/a30188ac8efa66536a2ec7e823563a4749ddfa1f))
* Use pencil icon to indicate editing ([46d0438](https://github.com/hhankj2u/StreamMaster/commit/46d04388b68de4e0aa639bd39970f111afafadfa))
* Use repo owner as actor ([fc3ecba](https://github.com/hhankj2u/StreamMaster/commit/fc3ecba56a904558826f7a840da9096905925118))
* Use split query by default ([2b4e65c](https://github.com/hhankj2u/StreamMaster/commit/2b4e65c8273da447b838b273e18ffbfd2d1534f2))
* version bump ([40edd2f](https://github.com/hhankj2u/StreamMaster/commit/40edd2f2725d9f268e8cabf1e2142f580984c3de))
* version bump ([963b260](https://github.com/hhankj2u/StreamMaster/commit/963b260c55abfe2223701d994ba8f521b6d722c3))
* version bump ([bcfaa98](https://github.com/hhankj2u/StreamMaster/commit/bcfaa983975259504938073de465c1121a120342))
* version bump ([e10bef6](https://github.com/hhankj2u/StreamMaster/commit/e10bef671770fcfff43e1aa8147bc4dd6c111240))
* Wrap in quotes to avoid bad names ([0365eb1](https://github.com/hhankj2u/StreamMaster/commit/0365eb134f249323ef041e3ddfc2b1b6685855bb))
* yt debugging ([4e4cbc2](https://github.com/hhankj2u/StreamMaster/commit/4e4cbc25d09630c520cc663c461bf4a86c285d6c))


### Features

* Add `CacheEPGChannelLogosAsync` when caching ([3ce5d3f](https://github.com/hhankj2u/StreamMaster/commit/3ce5d3fb587de25aab259bec0cdca8fa145611b2))
* Add `HandleSStreamRequest` functionality ([7b20400](https://github.com/hhankj2u/StreamMaster/commit/7b2040044af6926c46c6da6da9bd707045c17a03))
* add <category> for schedules direct EPG ([aa17558](https://github.com/hhankj2u/StreamMaster/commit/aa1755869c433450e7b4e726809b53577f0192e7))
* Add auto set EPG button more front facing ([464aa01](https://github.com/hhankj2u/StreamMaster/commit/464aa01d5365f01a777b323cb07fa3e038ed0b33))
* Add Devices support ([704914c](https://github.com/hhankj2u/StreamMaster/commit/704914c7b7f89652a124e3aa13a3f954e54338cf))
* Add new `DbSet` for `UserGroups`, `M3UGroups`, `APIKeys`, and `Devices` ([7f0b07b](https://github.com/hhankj2u/StreamMaster/commit/7f0b07b9d889921b89d23497b874884f8cb406e9))
* Add new API method for checking if system is ready ([33093d7](https://github.com/hhankj2u/StreamMaster/commit/33093d735c16fdcca2b9af515c50483272d99f92))
* Add new feature for user ([d9afed5](https://github.com/hhankj2u/StreamMaster/commit/d9afed5d81a5376cb6bad4958eed791b676f17a8))
* Add option to format EPG output ([6d88a38](https://github.com/hhankj2u/StreamMaster/commit/6d88a38ce7f7e9aedbdd08d887072bed2557c7d0))
* Add Play Stream dialog ([9504cdd](https://github.com/hhankj2u/StreamMaster/commit/9504cdd8c2425ed524dda204799a97d72ffeefa0))
* Add typescript types for new modoels ([673e4b2](https://github.com/hhankj2u/StreamMaster/commit/673e4b23d45a13a201eeb8bc23cb9ac61cb8bcf3))
* Add validation of PUID and PGID values ([7ed4915](https://github.com/hhankj2u/StreamMaster/commit/7ed4915ddbd0c1c0b9068f4fc3de8785ab04169a))
* Additional log output when migrating ([57becdf](https://github.com/hhankj2u/StreamMaster/commit/57becdf30b5a6e04e4bbebe3fe3afc21779cd5f5))
* Align with `M3UFileId` changes ([0853a38](https://github.com/hhankj2u/StreamMaster/commit/0853a38a5b44f9731cf09dc8bc7a7cf0d9fc7ad8))
* API keys support ([0759664](https://github.com/hhankj2u/StreamMaster/commit/075966486add5ddf64b8164fd9e7bc5fbc8b4690))
* Avoid running `tests` if no code changed ([836c7e6](https://github.com/hhankj2u/StreamMaster/commit/836c7e6867ac6c37fea8681f3dcba08cce24afd2))
* Backups ([3a6174f](https://github.com/hhankj2u/StreamMaster/commit/3a6174ff9bfbc9131fadc4e71588655104c0496f))
* Give credit to contributors ([96b90c6](https://github.com/hhankj2u/StreamMaster/commit/96b90c6897e367a90d379d582f98deec9f160118))
* Handle directory creation with fail output ([341fd2b](https://github.com/hhankj2u/StreamMaster/commit/341fd2b5e21c562dd86bda1374c8d7e08d5e5eac))
* Handle faulire cases ([8126757](https://github.com/hhankj2u/StreamMaster/commit/8126757c93da5a23a44c4ab657d992cab6da4830))
* Improve program/logo handling in XMLTV ([faa3cb9](https://github.com/hhankj2u/StreamMaster/commit/faa3cb9b435daac95543e71bad3f7fbc4aff3163))
* improved dropdown options UI styling ([cdc66c4](https://github.com/hhankj2u/StreamMaster/commit/cdc66c41eb547be1697641dc4dc04abb4894d1ad))
* Make PostgreSQL wait parameters configurable ([c945727](https://github.com/hhankj2u/StreamMaster/commit/c945727dfce1672b06f57508c91cb8790313fc65))
* Mirror images to Docker Hub ([5af71d2](https://github.com/hhankj2u/StreamMaster/commit/5af71d2a28307e9f8cb472c3947c4f6d5b5ee091))
* Output failures when `chown` ([828270c](https://github.com/hhankj2u/StreamMaster/commit/828270c54f6e3fcc997f148a1dfe720059f8fd7a))
* pgsql ([315d5ea](https://github.com/hhankj2u/StreamMaster/commit/315d5ead57e6c0e563cda2d942d16e29197473b8))
* POSTGRES_USER_FILE and POSTGRES_PASSWORD_FILE ([e5b0f7c](https://github.com/hhankj2u/StreamMaster/commit/e5b0f7c96f2f853732b4f07009a1a833603e136d))
* Re-configure semantic release ([d425883](https://github.com/hhankj2u/StreamMaster/commit/d4258838079281c97fa30ffe10f3e83cf6ede23c))
* Recover stream migration bash script ([ee96629](https://github.com/hhankj2u/StreamMaster/commit/ee96629801a54de60ad0c95c00100081c61982f7))
* removed buffer, optimized streaming ([#209](https://github.com/hhankj2u/StreamMaster/issues/209)) ([4553c81](https://github.com/hhankj2u/StreamMaster/commit/4553c812926b61415d04798778d09a8fca4f4cdd))
* Reset method now uses EPG Number instead of ID ([d2f8996](https://github.com/hhankj2u/StreamMaster/commit/d2f8996d94ce1759b67c32077753056e61f02b41))
* Rewrite CircularBuffer and include tests ([89d9348](https://github.com/hhankj2u/StreamMaster/commit/89d93484a5cd32943df57ac2874adc1937f1b54b))
* Run tests as part of build pipeline ([5d33b33](https://github.com/hhankj2u/StreamMaster/commit/5d33b337a5a5c021cd13cb16c40008417675c63c))
* Set Streammaster specific UA for SD ([49b7448](https://github.com/hhankj2u/StreamMaster/commit/49b7448f2f931e620042a95089d67b430ef02f36))
* Split workflow/shared workflow ([ba1b3fe](https://github.com/hhankj2u/StreamMaster/commit/ba1b3fe56f17e828c229db976ae887cc703be782))
* Toggle on/off short links ([4bf8658](https://github.com/hhankj2u/StreamMaster/commit/4bf8658d81ffa8e691178a4ab097ccdfb3a7d20d))
* Update README ([c86c1de](https://github.com/hhankj2u/StreamMaster/commit/c86c1deebc3bbde725ac64155e96a600fd9c1210))
* Updated regex pattern for capturing version, optional branch, ([0e2c256](https://github.com/hhankj2u/StreamMaster/commit/0e2c256ed7034508f5db4490e269be21dda41bfc))
* Video player fallback to hls/mpegts ([ba8c87e](https://github.com/hhankj2u/StreamMaster/commit/ba8c87e1b8ebc35d3b601b71bede7991e90bc3a7))
